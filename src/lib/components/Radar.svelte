<script lang="ts">
	...
	export let bundle: gs;
	export let family: gs;
	export let premium: gs;
	...
	<div class="rounded-lg bg-gray-50 p-3 dark:bg-gray-700">
		<div class="mb-2 grid grid-cols-3 gap-3">
			...
			>
				...
				<dd class="text-sm font-medium text-orange-600 dark:text-orange-300">Bundle Plan</dd>
			</dl>
			<dl
			...
			>
				...
				<dd class="text-sm font-medium text-teal-600 dark:text-teal-300">Family Plan</dd>
			</dl>
			<dl
			...
			>
				...
				<dd class="text-sm font-medium text-blue-600 dark:text-blue-300">Premium</dd>
			</dl>
		</div>
		<button
